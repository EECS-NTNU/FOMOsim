...
class Area():
    ...
    def __init__(
        ...
        self.center_location = center_location if center_location == None else self.get_center_vertices()
    ...
    def get_center_vertices(self):
        sum_lon = sum(v[0] for v in self.border_vertices)
        sum_lat = sum(v[1] for v in self.border_vertices)

        n = len(self.border_vertices)
