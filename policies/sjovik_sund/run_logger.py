...
_ALL_FEATURE_NAMES = _get_all_feature_names(True, True, True)
...
class RunLogger:
    ...
    def __init__(
        ...
        self._policy_type: str = "Hybrid"   # "Hybrid" or "VFA"
    ...
    def set_run_label(
        ...
        self.debug(f"Run label: exp={exp_name} alpha={alpha} policy={policy_type}")
