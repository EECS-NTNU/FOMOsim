...
class Dual_Policy(Policy): #Add default values from seperate setting sheme
    ...
    def calculate_loading_quantities_and_swaps_pilot(self, vehicle, simul, station, eta):
        ...
        if num_escooters_station_at_arrival_accounted_battery_swap < target_state:
            ...
            number_of_less_escooters = min(remaining_cap_vehicle, num_escooters_station_at_arrival_accounted_battery_swap - target_state + BIKES_CONGESTED_NEIGHBOR * overflowing_neighbors)
...
def find_potential_stations(simul, cutoff_vehicle, cutoff_station, vehicle, bikes_at_vehicle, tabu_list):
    ...
    for station in potential_stations:
        ...
        adjusted_demand = station.number_of_bikes() + net_demands[station.location_id]
