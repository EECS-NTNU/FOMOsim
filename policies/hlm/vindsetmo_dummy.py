...
class Vindsetmo_dummy(Policy): #Add default values from seperate setting sheme
    def __init__(self, 
                max_depth = MAX_DEPTH, 
    ...
    def get_best_action(self, simul, vehicle):
        ...
        if number_of_escooters_deliver > 0:
            escooters_to_deliver = random.sample(escooters_in_vehicle_list_id, k=number_of_escooters_deliver)
