...
def test_upper_threshold(list_of_seeds, upper_thresholds):
    for threshold in upper_thresholds:
        ...
        policy=policies.hlm.BS_PILOT(upper_threshold=threshold)
        test_seeds_mp(list_of_seeds, policy, filename)
...
if __name__ == "__main__":
    ...
    policy_dict = dict(dual = policies.hlm.Dual_Policy(
    ...
    # test_upper_threshold(list_of_seeds=list_of_seeds, upper_thresholds=[45])
