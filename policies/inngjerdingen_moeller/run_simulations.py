...
>>>>>>> parent of 023246a (Merge branch 'Inngjerdingen' into Møller)
...
if __name__ == "__main__":
    ...
    policy_dict = dict(pilot = policies.inngjerdingen_moeller.PILOT(2, 5, 30, criticality_weights_sets, evaluation_weights, number_of_scenarios), greedy = policies.GreedyPolicy(), do_nothing = policies.DoNothing())
