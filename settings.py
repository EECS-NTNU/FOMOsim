...
MAINTENANCE_INCREASE_PER_MINUTE = 0.005 # Increase in maintenance criticality for each minute the bike is in use (0.01 = 0.10%, 100 minutes use -> 100%)
...
MAINTENANCE_FULL_FIX = 3 # Maintenance time for full fix per bike
