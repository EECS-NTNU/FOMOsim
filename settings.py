...
MAINTENANCE_INCREASE_PER_MINUTE = 0.0025 # Increase in maintenance criticality for each minute the bike is in use. (1 = 100%, full maintenance after 400 minutes use)   
